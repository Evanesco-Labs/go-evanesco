...
func TestSignTxRequest(t *testing.T) {
	...
	function ApproveTx(r){
		...
		if(r.transaction.from.toLowerCase()=="Ex0000000000000000000000000000000000001337"){ return "Approve"}
		if(r.transaction.from.toLowerCase()=="Ex000000000000000000000000000000000000dead"){ return "Reject"}
	}`
...
function ApproveSignData(r){
    if( r.address.toLowerCase() == "Ex694267f14675d7e1b9494fd8d72fefe1755710fa")
    {
	...
	addr, _ := mixAddr("Ex694267f14675d7e1b9494fd8d72fefe1755710fa")
